                  ...
                  builder: (context, child) {
                    return Container(
                      ...
                      margin: EdgeInsets.only(
                          bottom: (1 - _ac.value) * widget.margin.vertical,
                          left: (1 - _ac.value) * widget.margin.horizontal / 2,
                          right:
                              (1 - _ac.value) * widget.margin.horizontal / 2),
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Positioned(
                            ...
                            width: MediaQuery.of(context).size.width -
                                (widget.margin != null
                                    ? (1 - _ac.value) * widget.margin.horizontal
                                    : 0) -
                                (widget.padding != null
                                    ? widget.padding.horizontal
                                    : 0),
